...
module uart_top #(
    ...
    //   STREAM_REG = reg[STREAM_REG_IDX]   
    //   STATUS_REG = reg[STATUS_REG_IDX]   
    ...
    output logic                         o_wr_fifo_stuck,       //  WR FIFO was ever not-ready when a write was attempted
    ...
    //==========================================================================
    // Status overlay for reg[STATUS_REG_IDX]:
    //   read result = {3'b0, bytes_written[28:0]}
    //==========================================================================
